...
/**
 * This is the item provider adapter for a {@link de.tubs.cs.isf.requirementseditor.AND} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ANDItemProvider extends ExpressionItemProvider {
	...
	protected void addOperand2PropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_AND_operand2_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_AND_operand2_feature", "_UI_AND_type"),
						RequirementsEditorPackage.Literals.AND__OPERAND2, true, false, false,
	...
	public String getText(Object object) {
		String label = ((AND) object).getOperand1();
	...
	public void notifyChanged(Notification notification) {
		...
		case RequirementsEditorPackage.AND__OPERAND2:
