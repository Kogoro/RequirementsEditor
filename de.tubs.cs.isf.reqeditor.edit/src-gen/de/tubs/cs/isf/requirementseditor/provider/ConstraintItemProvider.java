...
/**
 * This is the item provider adapter for a {@link de.tubs.cs.isf.requirementseditor.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_name_feature",
								"_UI_Constraint_type"),
						RequirementsEditorPackage.Literals.CONSTRAINT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Constraint_expression_feature",
								"_UI_Constraint_type"),
						RequirementsEditorPackage.Literals.CONSTRAINT__EXPRESSION, true, false, false, null, null,
						null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case RequirementsEditorPackage.CONSTRAINT__NAME:
		case RequirementsEditorPackage.CONSTRAINT__EXPRESSION:
