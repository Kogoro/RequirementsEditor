...
/**
 * This is the item provider adapter for a {@link de.tubs.cs.isf.requirementseditor.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider extends RequirementModelElementItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						RequirementsEditorPackage.Literals.REQUIREMENT__TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Requirement_priority_feature",
								"_UI_Requirement_type"),
						RequirementsEditorPackage.Literals.REQUIREMENT__PRIORITY, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementsEditorPackage.Literals.REQUIREMENT__ATTRIBUTES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case RequirementsEditorPackage.REQUIREMENT__TYPE:
		case RequirementsEditorPackage.REQUIREMENT__PRIORITY:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case RequirementsEditorPackage.REQUIREMENT__ATTRIBUTES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RequirementsEditorPackage.Literals.REQUIREMENT__ATTRIBUTES,
				RequirementsEditorFactory.eINSTANCE.createAttributeValue()));
	}
